...
from database import add_infraction
...
class LoggingMonitor(commands.Cog):
    ...
    async def log_action(
        ...
        """
        Creates the database infraction and MonitorUUID .txt file.

        IMPORTANT:
        The UUID is generated by database.add_infraction(), so the
        UUID stored in the database and the UUID written to the file
        ...
        log_content = (
            ...
            f"Moderator ID: {moderator_id or 'Unknown'}\n"
            f"\n"
            f"Reason: {reason}\n"
        )
        ...
        try:
            ...
            print(
                f"[LoggingMonitor] Failed to write UUID file: {e}"
            )
    ...
    def create_embed(
        ...
        # UUID is explicitly displayed here.
        embed.add_field(
            name="Event UUID",
            value=f"`{event_uuid}`",
            inline=False
    ...
    async def on_member_ban(self, guild, user):
        """
        Automatically logs bans detected through Discord audit logs.
        """
    ...
    async def on_member_remove(self, member):
        """
        Automatically logs kicks detected through Discord audit logs.
        """
