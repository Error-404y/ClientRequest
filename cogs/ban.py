...
class BanCog(commands.Cog):
    ...
    async def banz_slash(
        ...
        description = f"Are you sure you want to ban **{target_name}**?"
    ...
    async def unbanz_slash(
        ...
        description = f"Are you sure you want to unban **{target_name}**?"
    ...
    async def infraction_slash(
        ...
        if infraction:
            ...
            if not interaction.guild or infraction_guild_id != interaction.guild.id:
                infraction = None
        ...
        if ticket:
            ...
            if not interaction.guild or ticket_guild_id != interaction.guild.id:
                ticket = None
    ...
    async def infraction_prefix(
        ...
        if infraction:
            if action_value == "remove":
                ...
                await ctx.send(embed=self._build_removed_infraction_embed(removed))
                return

            await ctx.send(embed=self._build_infraction_embed(infraction))
            return
        ...
        if ticket:
            ...
            await ctx.send(embed=await self._build_ticket_embed(ticket, ctx.guild))
            return
